...
class FilteredBlogsWidget extends StatefulWidget {
  const FilteredBlogsWidget({
    Key key,
    this.filter,
    this.user,
  }) : super(key: key);
  ...
  @override
  _FilteredBlogsWidgetState createState() => _FilteredBlogsWidgetState();
}

class _FilteredBlogsWidgetState extends State<FilteredBlogsWidget> {
            ...
            children: [
              ...
              StreamBuilder<List<BlogsRecord>>(
                stream: queryBlogsRecord(
                  queryBuilder: (blogsRecord) => blogsRecord.where('category',
                      arrayContains: widget.filter),
                ),
